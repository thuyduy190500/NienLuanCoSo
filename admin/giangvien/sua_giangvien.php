<?php
        ...
        $MaGV=$_GET['MaGV'];
        $query=mysqli_query($con,"SELECT * FROM giangvien
...
if(!empty($_POST)){
    ...
    $diachi= $_POST['diachi'];
    $sql="UPDATE giangvien SET MaGV='$magv',TenGV='$hoten', NamSinh='$namsinh',SDT='$sdt',GioiTinh='$gioitinh', DiaChi='$diachi' WHERE MaGV='$MaGV'";
...
<body>
    ...
    <div class="wrapper rounded bg-white">
        <div class="h3">Cập nhật giảng viên</div>
        <div class="form">
            <form action="" method="POST">
                <div class="row">
                    <div class="col-md-6 mt-md-0 mt-3">
                        <label >Mã giảng viên</label>
                        <input type="text " value="<?php echo $row['MaGV'];?>" class="form-control" name="magv" required>
                    </div>
                    <div class="col-md-6 mt-md-0 mt-3"> 
                        <label >Họ tên</label>
                        <input type="text" value="<?php echo $row['TenGV'];?>" class="form-control"  name="hoten" required >
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 mt-md-0 mt-3">
