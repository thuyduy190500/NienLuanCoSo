...
if(!empty($_POST)){
    ...
    $diachi= $_POST['diachi'];
    $chucvu= $_POST['chucvu'];
    $sql="UPDATE nhanvien SET MaNV='$manv',TenNV='$hoten', NamSinh='$namsinh',GioiTinh='$gioitinh',SDT='$sdt', DiaChi='$diachi',ChucVu='$chucvu' WHERE MaNV='$MaNV'";
...
<div class="wrapper rounded bg-white">
    <div class="h3">Cập nhật nhân viên</div>
    <div class="form">
        <form action="" method="POST">
            <div class="row">
                <div class="col-md-6 mt-md-0 mt-3">
                    <label >Mã nhân viên</label>
                    <input type="text " value="<?php echo $row['MaNV'];?>" class="form-control" name="manv" required>
                </div>
                <div class="col-md-6 mt-md-0 mt-3"> 
                    <label >Họ tên</label>
                    <input type="text" value="<?php echo $row['TenNV'];?>" class="form-control"  name="hoten" required >
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 mt-md-0 mt-3">
