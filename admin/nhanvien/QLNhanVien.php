...
<body>
    ...
    <div class="sidebar">
        <div class="sidebar-content">
            ...
            <a class="active"  href="../nhanvien/QLNhanVien.php">Quản lý nhân viên</a>
        ...
        <div class="content">
            ...
            <div class="search">
                <form action="" method="GET">
                    <input type="text"  name="search" placeholder="tìm kiếm theo Mã NV">
                    <button class="btn" name="btn" type="submit"><i class="fas fa-search"></i></button>
                </form>
            </div>
            <a href="them_nhanvien.php">Thêm nhân viên</a>
           <div class="table-mg">
                <table class="table table-striped">
                    ...
                    <?php
                        ...
                        foreach ($std as  $s) {
                            ...
                            <tr> 
                                <td> 
                                    <a class="setting" href="sua_nhanvien.php?MaNV='.$s['MaNV'].'"><i class="fas fa-pencil-alt"></i></a>
                                    <a class="setting" href="xoa_nhanvien.php?MaNV='.$s['MaNV'].'"><i class="fas fa-trash-alt"></i></a>
                                </td>
                                <td>'.($index++).' </td>
                                <td>'.$s['MaNV'].' </td>
                                <td>'.$s['TenNV'].' </td>
