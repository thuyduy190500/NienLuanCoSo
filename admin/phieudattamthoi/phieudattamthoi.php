...
<head>
    ...
    <title>Phiếu đặt chỗ online</title>
    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>                                        
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-content">
                ...
                <a class="active" href="">Phiếu đặt chỗ online</a>
        ...
        <!-- Page content -->
        <div class="content">
            <div class="content-title">DANH SÁCH PHIẾU ĐẶT CHỖ ONLINE</div>
            <div class="search">
           ...
           <div class="table-mg">
                <table class="table table-striped">
                    ...
                    <?php
                        ...
                        if(isset($_GET['btn'])){
                            $search = $_GET['search'];
                            $query="SELECT * FROM datchotamthoi WHERE HoTen LIKE '%$search%'";
                        }else{
                            $query="SELECT * FROM datchotamthoi";
                        ...
                        foreach ($std as  $s) {
                            ...
                            <tr> 
                                <td style="width: 80px;"> 
                                    <a class="setting" href="sua_phieudattamthoi.php?MaPhieu='.$s['MaPhieu'].'"><i class="fas fa-pencil-alt"></i></a>
                                    <a class="setting" href="xoa_phieudattamthoi.php?MaPhieu='.$s['MaPhieu'].'"><i class="fas fa-trash-alt"></i></a>
                                </td>
                                <td>'.($index++).' </td>
                                <td>'.$s['MaPhieu'].' </td>
                                ...
                                <td>
                                    <form >
                                        <select name="" id="" style="border:none" selected="'.$s['TrangThai'].' ">
