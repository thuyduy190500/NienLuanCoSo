    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>                                        
        ...
        <div class="sidebar">
            <div class="sidebar-content">
                ...
                <a class="active" href="">Quản lý học viên</a>
        ...
        <div class="content">
            ...
            <div class="search">
                <form action="" method="GET">
                    <input type="text"  name="search" placeholder="tìm kiếm theo Mã HV">
                    <button class="btn" name="btn" type="submit"><i class="fas fa-search"></i></button>
                </form>
            </div>
        <!-- tìm kiếm -->
            <a href="them_hocvien.php">Thêm học viên</a>
           <div class="table-mg">
                <table class="table table-striped">
                    ...
                    <?php
                        ...
                        if(isset($_GET['btn'])){
                            $search = $_GET['search'];
                            $query="SELECT hocvien.MaHV, hocvien.TenHV, hocvien.NamSinh, hocvien.GioiTinh, hocvien.SDT, hocvien.DiaChi, lophoc.TenLop
                            from hocvien, lophoc, phieudatcho
                            where hocvien.MaHV=phieudatcho.MaHV and phieudatcho.MaLop= lophoc.MaLop and hocvien.MaHV='$search'";
                        }else{
                            $query="SELECT hocvien.MaHV, hocvien.TenHV, hocvien.NamSinh, hocvien.GioiTinh, hocvien.SDT, hocvien.DiaChi, lophoc.TenLop
                            from hocvien, lophoc, phieudatcho
                            where hocvien.MaHV=phieudatcho.MaHV and phieudatcho.MaLop= lophoc.MaLop";
                        }
                        ...
                        foreach ($std as  $s) {
                            ...
                            <tr> 
                                <td> 
                                    <a class="setting" href="sua_hocvien.php?MaHV='.$s['MaHV'].'"><i class="fas fa-pencil-alt"></i></a>
                                    <a class="setting" href="xoa_hocvien.php?MaHV='.$s['MaHV'].'"><i class="fas fa-trash-alt"></i></a>
                                </td>
                                <td>'.($index++).' </td>
                                <td>'.$s['MaHV'].' </td>
                                <td>'.$s['TenHV'].' </td>
