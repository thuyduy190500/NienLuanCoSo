...
if(!empty($_POST)){
    ...
    $diachi= $_POST['diachi'];
    $malop= $_POST['lophoc'];
    $sql="UPDATE hocvien SET MaHV='$MaHV', TenHV='$hoten',NamSinh='$namsinh',GioiTinh='$gioitinh', SDT='$sdt', DiaChi='$diachi' WHERE MaHV='$MaHV' ";
    $result1=$con->query($sql);
    $sql_edit="UPDATE phieudatcho SET MaLop='$malop' WHERE MaHV ='$MaHV'";
...
<body>
    ...
    <div class="wrapper rounded bg-white">
        <div class="h3">Cập nhật học viên</div>
        <div class="form">
            <form action="" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mt-md-0 mt-3">
                        <label >Lớp học</label>
                        <select class="form-control" name="lophoc" value="<?php echo $row['MaLop'];?>" required>
                        <?php
